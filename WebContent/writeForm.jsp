...
function validate(frm){
	if(frm.title.value==''){alert("제목을 입력하세요."); return false;}
		...
		if(frm.title.value.length>40){
			alert("제목은 40자 이내로 작성하세요."); return false;
		}
	}
	if(frm.writer_name.value==''){alert("닉네임을 입력하세요."); return false;}
	if(frm.password.value==''){
		alert("암호를 입력하세요. 글 삭제나 수정시 필요합니다.");return false;}
	if(frm.imagename.value==''){alert("이미지를 선택하세요."); return false;}
